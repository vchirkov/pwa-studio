...
module.exports = function buildRichContentRendererArray(source) {
    ...
    const sourceWithImports = insertAtSection(source, 'imports', importStatements);
    const sourceWithExports = insertAtSection(sourceWithImports, 'exports', exportComponents);
